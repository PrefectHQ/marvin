...
Set up your LLM provider. By default, Marvin uses OpenAI:
...
# Run a simple task
result = marvin.run("Write a haiku about Python programming")
print(result)
```
```text Result
Indented lines flow
...
```
```text Result
June saw above-average rainfall (3.5 inches) and moderate temperatures averaging 72°F, with mostly sunny to partly cloudy conditions.
```
</CodeGroup>
