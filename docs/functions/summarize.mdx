...
summary = marvin.summarize(
    text,
    instructions="Summarize in three bullet points"
)
print(summary)
```

```python Result
"• High-end display with 6.7-inch OLED screen and triple cameras
• Advanced features including 5G and AI-enabled custom chip
• All-day battery life with pricing from $999"
```
</CodeGroup>
