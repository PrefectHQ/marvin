...
### `classify`
```python
def classify(data: Any, labels: Sequence[T] | type[T], multi_label: bool = False, instructions: str | None = None, agent: Agent | None = None, thread: Thread | str | None = None, context: dict[str, Any] | None = None) -> T | list[T]
```
...
### `classify_async`
```python
def classify_async(data: Any, labels: Sequence[T] | type[T], multi_label: bool = False, instructions: str | None = None, agent: Agent | None = None, thread: Thread | str | None = None, context: dict[str, Any] | None = None) -> T | list[T]
```
